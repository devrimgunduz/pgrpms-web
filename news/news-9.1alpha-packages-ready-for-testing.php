<?php include "inc/top.inc.php"; ?>
    ...
    <h1> PostgreSQL 9.1 alpha packages are ready for testing</h1>
	<p>
	If you are a Fedora-12-13 and/or RHEL/CentOS 4,5 user and want to test 
	new features of PostgreSQL 9.1 and help development team, you 
	...
	9.1 packages. You may want to install -debuginfo RPM, which may 
	help PostgreSQL developers to get some data in case you find a 
	bug.
	</p><p>
	Source RPMs are also available:
	</p><p>
	<a href="http://yum.pgrpms.org/srpms/9.1">http://yum.pgrpms.org/srpms/9.1</a>
	(and they are installable using yum).
	</p><p>
	Please report any packaging related errors to <a 
	href=/contact.php">us</a>. If you find any PostgreSQL 9.1 bugs, 
