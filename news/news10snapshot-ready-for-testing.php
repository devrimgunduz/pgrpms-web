<?php include "inc/top.inc.php"; ?>
    ...
    <h1> PostgreSQL 10 snapshot RPMS are ready for testing</h1>
	<p>
	<font color="red">These are not stable packages. Use them at your own risk. <b>They
	are not ready for production.</b>.</font>
	</p><p>
	If you are a RHEL/CentOS/Scientific Linux/Oracle Linux 7 or Fedora 25
        user, and want to test new big features of PostgreSQL 10, and help
        development team, you may use the packages that we will release
        frequently during development cycle, based on GIT shapshots.
	</p><p>
