<?php include "inc/top.inc.php"; ?>
    ...
    <h1> PostgreSQL 8.5 alpha packages are ready for testing</h1>
	<p>
	If you are a Fedora-7,8,9,11 or RHEL/CentOS 4,5 user and want to test 
	new features of PostgreSQL 8.5 and help development team, you 
	...
	8.5 packages. You may want to install -debuginfo RPM, which may 
	help PostgreSQL developers to get some data in case you find a 
	bug.
	</p><p>
	Source RPMs are also available:
	</p><p>
	<a href="http://yum.pgrpms.org/srpms/8.5">http://yum.pgrpms.org/srpms/8.5</a>
	(and they are installable using yum).
	</p><p>
	Please report any packaging related errors to <a 
	href=/contact.php">us</a>. If you find any PostgreSQL 8.5 bugs, 
